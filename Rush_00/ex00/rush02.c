...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/03/08 17:36:38 by lupin             #+#    #+#             */
/*   Updated: 2026/03/08 17:45:20 by lupin            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	rush(int x, int y)
{
	...
	if (x < 1 || y < 1)
		return ;
	print_row(x, init_row, init_row, h_space);
	--y;
	while (y > 1)
	{
	...
	if (y == 1)
		print_row(x, final_row, final_row, h_space);
}
